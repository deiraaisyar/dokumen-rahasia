...
def run_evaluating():
    ...
    mappings = [
        {
            "doc": "doc1",
            "gen": Path("./data/generated_outputs/doc1.csv"),
            "ref": Path("./data/preprocessed_outputs/1. IVC DOE (Final).csv"),
            "key": "Risk ID",
        },
        {
            "doc": "doc2",
            "gen": Path("./data/generated_outputs/doc2.csv"),
            "ref": Path("./data/preprocessed_outputs/2. City of York Council (Final).csv"),
            "key": "Risk ID",
        },
        {
            "doc": "doc3",
            "gen": Path("./data/generated_outputs/doc3.csv"),
            "ref": Path("./data/preprocessed_outputs/3. Digital Security IT Sample Register (Final).csv"),
            "key": "Number",
        },
    ]
    ...
    out_path = Path("./data/generated_outputs/evaluation_doc1_doc3.csv")
